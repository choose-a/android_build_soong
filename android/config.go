...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Choose.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.ChooseConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Choose.Specific_camera_parameter_library)
}
...
func (c *deviceConfig) QTIAudioPath() string {
	return String(c.config.productVariables.Choose.QTIAudioPath)
}

func (c *deviceConfig) QTIDisplayPath() string {
	return String(c.config.productVariables.Choose.QTIDisplayPath)
}

func (c *deviceConfig) QTIMediaPath() string {
	return String(c.config.productVariables.Choose.QTIMediaPath)
}
